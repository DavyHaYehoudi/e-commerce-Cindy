  ...
  return (
    <>
      ...
      <input
        ...
        required
        className={validationErrors["card-number"] ? "error" : ""}
        onFocus={handleFocus}
      ...
      <input
        ...
        required
        className={validationErrors["expiration-date"] ? "error" : ""}
        onFocus={handleFocus}
        onChange={handleChange}
      />
      <input
        ...
        required
        className={validationErrors["security-code"] ? "error" : ""}
        onFocus={handleFocus}
        onChange={handleChange}
      />
      <input
        ...
        required
        className={validationErrors["card-name"] ? "error" : ""}
        onFocus={handleFocus}
        onChange={handleChange}
      />
    </>
