      ...
      <div className="animated-container">
        ...
        <div id="termsOfSales-contain">
          <p>
            ...
            Atelier Noralya dont le siège social est situé au 555, Avenue de la
            république 83560 VINON-SUR-VERDON, inscrit sous le numéro SIRET
            91861010600018, code APE 9609Z et d’autre part, par toute personne
            physique ou morale dénommée ci-après " le CLIENT " souhaitant
            procéder à un achat via le site Internet
            de www.atelier-noralya.com .
          </p>
          <h2>objet</h2>
          <p>
            ...
            Atelier Noralya.
            <br />
            Atelier Noralya se réserve le droit de pouvoir modifier ses
            conditions de vente à tout moment.
          ...
          <p>
            ...
            <br /> Atelier Noralya veille à ce que le modèle soit réalisé au
            plus près de l'article présenté sur le site
            www.atelier-noralya.com (sauf demandes de personnalisation).
            <br />
          ...
          <h2>prix</h2>
          <p>
            Les prix des produits vendus sont ceux en vigueur le jour de la
            prise de commande.
          ...
          <p>
            Pour passer une commande, le Client doit s'identifier avec son
            adresse email et son mot de passe. Pour toute première commande, le
            Client devra suivre une procédure de création de compte indiquée sur
            le Site Internet.
          </p>
          <h2>paiement</h2>
          <p>
            ...
            sécurisée STRIPE.
            <br /> Toutes les transactions sont sécurisées et chiffrées par
            cette plateforme.
            ...
            :https://stripe.com/fr
            <br />
            Le Client reconnaît expressément que la communication du numéro de
            sa carte bancaire à Atelier Noralya vaut autorisation de débit de
            son compte à concurrence du prix de sa Commande.
            <br /> La carte bancaire du Client sera débitée au moment de la
            confirmation de sa Commande.
            <br /> A cette fin, le Client garantit qu’il est titulaire de la
            carte bancaire à débiter et que le nom y figurant est bien le sien.
            <br />
            Le cas échéant, une notification d’annulation de Commande pour
            défaut de paiement est envoyée au Client par Atelier Noralya sur
            l’adresse mail communiquée par le Client.
            <br /> Atelier Noralya se réserve le droit de suspendre toute
            gestion de Commande ou toute livraison en cas d’impayé ou d’incident
            de paiement (coordonnées bancaires fausses, défaut de provision du
            ...
            Noralya.
            <br />
            Une facture acquittée reprenant les différents éléments de la
            Commande est envoyée par mail au Client.
            <br />
            ...
            sommes dues.
            <br /> C’est à la réception du paiement que la Commande du Client
          ...
          <p>
            Toute réclamation du Client devra être faite par écrit et transmise
            à l’adresse électronique suivante : <br />
            ...
            VINON-SUR-VERDON
            <br />
            En vertu de l’article 14, al. 1 de la directive européenne
            2013/11/UE du 21 mai 2013 relative au RELC, la Commission Européenne
            met à la disposition des consommateurs une plateforme en ligne de
            règlement des litiges disponible à cette adresse :<br />
             http://ec.europa.eu/
          </p>
          ...
          <p>
            ...
            utiliser à quelque titre que ce soit, même partiellement, les
            éléments visuels du site (Images, photographies) sauf avec
            autorisation. 
            <br />
            Attention: Les modèles des bijoux de la marque Atelier Noralya ne
            sont pas libres de droit - Reproduction interdite
            <br />
